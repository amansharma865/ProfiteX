  ...
  return (
    <div className='bg-[#051708] mt-16 pl-12 pr-16 mx-auto py-16 px-4 grid lg:grid-cols-3 gap-8 text-gray-300 rounded-t-[75px]'>
      ...
      <div>
        ...
        <p className='py-4'>
          Streamline your business operations with ProfiteX - a comprehensive platform for inventory management, order tracking, and revenue analytics. Empowering businesses to grow and thrive.
        </p>
