      ...
      <div className="relative mt-[3px] flex h-[61px] w-[355px] flex-grow items-center justify-around gap-2 rounded-full bg-white px-2 py-2 shadow-xl shadow-shadow-500 dark:!bg-black-800 dark:shadow-none md:w-[365px] md:flex-grow-0 md:gap-1 xl:w-[365px] xl:gap-2">
        <div className="flex h-full items-center rounded-full bg-lightPrimary text-black-700 dark:bg-black-900 dark:text-white xl:w-[225px]">
          ...
          <input
            type="text"
            placeholder="Search..."
            className="block h-full w-full rounded-full bg-lightPrimary text-sm font-medium text-black-700 outline-none placeholder:!text-gray-400 dark:bg-black-900 dark:text-white dark:placeholder:!text-white sm:w-fit"
          />
        </div>
        <span
          ...
          children={
            <div className="flex w-[350px] flex-col gap-2 rounded-[20px] bg-white p-4 shadow-xl shadow-shadow-500 dark:!bg-black-700 dark:text-white dark:shadow-none">
              ...
              <a
                ...
                className="px-full linear flex cursor-pointer items-center justify-center rounded-xl border py-[11px] font-bold text-black-700 transition duration-200 hover:bg-gray-200 hover:text-black-700 dark:!border-white/10 dark:text-white dark:hover:bg-white/20 dark:hover:text-white dark:active:bg-white/10"
              >
                See Documentation
              </a>
              <a
                ...
                className="hover:bg-black px-full linear flex cursor-pointer items-center justify-center rounded-xl py-[11px] font-bold text-black-700 transition duration-200 hover:text-black-700 dark:text-white dark:hover:text-white"
              >
                Try Horizon Free
              </a>
            </div>
